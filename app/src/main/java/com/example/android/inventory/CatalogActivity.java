...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void insertProduct(){
        ...
        values.put(ProductEntry.COLUMN_PRODUCT_NAME, "Samsung phone");
        values.put(ProductEntry.COLUMN_PRODUCT_PRICE, 10);
        values.put(ProductEntry.COLUMN_PRODUCT_QUANTITY, 1);
        values.put(ProductEntry.COLUMN_PRODUCT_SUPPLIER, "public");
        values.put(ProductEntry.COLUMN_PRODUCT_IMAGE, getString(R.string.dummy_image_uri));
        ...
        Long id = Long.valueOf(ContentUris.parseId(newUri));
